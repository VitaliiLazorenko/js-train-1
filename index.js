...
function checkDataType(value) {
  const type = typeof value; // Отримуємо тип значення value за допомогою оператора typeof
  console.log('Значення "' + value + '" має тип "' + type + '".'); // Виводимо у консоль повідомлення, яке містить значення value та його тип
  return type; // Повертаємо тип значення value
}
...
function findMax(num1, num2) {
  if (num1 > num2) {
    ...
    return num1; // Якщо num1 більше num2, то num1 є максимальним, тому повертаємо num1
  } else {
...
function getDayOfWeek(dayNumber) {
  let day;
  switch (
    dayNumber // Використовуємо оператор switch для знаходження назви дня тижня залежно від dayNumber
  ) {
    case 1: // В кожному випадку (case) перевіряємо значення dayNumber і присвоюємо змінній day відповідну назву дня тижня
      day = "Понеділок"; // Якщо dayNumber = 1, то day = "Понеділок"
      break;
    case 2:
      day = "Вівторок"; // Якщо dayNumber = 2, то day = "Вівторок"
      break;
    case 3:
      day = "Середа"; // Якщо dayNumber = 3, то day = "Середа"
      break;
    case 4:
      day = "Четвер"; // Якщо dayNumber = 4, то day = "Четвер"
      break;
    case 5:
      day = "П'ятниця"; // Якщо dayNumber = 5, то day = "П'ятниця"
      break;
    case 6:
      day = "Субота"; // Якщо dayNumber = 6, то day = "Субота"
      break;
    case 7:
      day = "Неділя"; // Якщо dayNumber = 7, то day = "Неділя"
      break;
    default:
      day = "Невірний номер дня"; // Якщо значення dayNumber не співпадає з жодним з випадків, то day = "Невірний номер дня"
      break;
  }
...
function getVariableType(variable) {
  const message =
    typeof variable === "number" // Отримуємо тип змінної variable за допомогою оператора typeof
      ? // Встановлюємо відповідне повідомлення залежно від отриманого типу
        "Це число" // Якщо тип змінної - number, то повідомлення = "Це число"
      : typeof variable === "string"
      ? "Це рядок" // Якщо тип змінної - string, то повідомлення = "Це рядок"
      : typeof variable === "boolean"
      ? "Це булеве значення" // Якщо тип змінної - boolean, то повідомлення = "Це булеве значення"
      : "Це інший тип"; // В іншому випадку (якщо тип змінної не входить у попередні категорії), то повідомлення = "Це інший тип"
...
function memoizedArea() {
  ...
  return function (side) {
    ...
    const area = side * side; // Розраховуємо площу
    prevSide = side; // prevSide присвоюємо сторону квадрата
    prevResult = area; // prevResult просвоюємо площу квадрата
...
let cube = function (n) {
  return Math.pow(n, 3); // Повертаємо n в кубі
};
